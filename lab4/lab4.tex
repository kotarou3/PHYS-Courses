...
\begin{figure}
    ...
    \label{tab:part2_graph}
\end{figure}

Table \ref{tab:part2_data} lists the collected data points after removing the systematic error by using the same method as part 1. Figure \ref{tab:part2_graph} plots these points against the predicted values for an infinite solenoid. It was also noted that the B-field strength varied by up to \SI{0.05}{\milli\tesla} along the radial distance.
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[bfield]
            ...
            \addplot +[no marks, domain = 0.2:2.5] {0.0528311 + 0.143822 * x};
